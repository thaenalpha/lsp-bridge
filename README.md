...
| 23 | [intelephense](https://github.com/bmewburn/vscode-intelephense) | php | `npm i intelephense -g` Check [docs](https://github.com/bmewburn/intelephense-docs) for configurations |
